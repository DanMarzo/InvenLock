...
namespace InvenLock.Migrations
{
    ...
    [Migration("20230418021851_includeDefaultValues")]
    partial class includeDefaultValues
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InvenLock.Models.ContatoFuncionario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UltimaAtualizacao = new DateTime(2023, 4, 17, 23, 18, 51, 592, DateTimeKind.Local).AddTicks(1771)
                        });
                });
            ...
            modelBuilder.Entity("InvenLock.Models.Funcionario", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            FuncionarioId = 1,
                            Admissao = new DateTime(2023, 4, 17, 23, 18, 51, 592, DateTimeKind.Local).AddTicks(6550),
                            CPF = "56053311839",
                            FuncionarioCargo = 2,
                            Nome = "Dan",
                            NumOcorrencias = 0,
